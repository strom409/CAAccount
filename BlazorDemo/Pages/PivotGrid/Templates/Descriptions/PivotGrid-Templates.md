The [Pivot Grid](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxPivotGrid-1) component allows you to use native Razor markup to define custom templates for its elements.
