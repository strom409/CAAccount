The [Text Box](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxTextBox) is a UI component that enables a user to enter and edit a single line of text.
