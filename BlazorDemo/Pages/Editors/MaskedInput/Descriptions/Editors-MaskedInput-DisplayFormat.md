Use the [DisplayFormat](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxMaskedInput-1.DisplayFormat) property to format the Masked Input's display value when the editor is not focused.
