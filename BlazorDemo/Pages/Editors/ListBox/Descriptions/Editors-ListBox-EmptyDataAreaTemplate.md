...
* The [Data](https://docs.devexpress.com/Blazor/DevExpress.Blazor.Base.DxListEditorBase-2.Data) property is unset.
* The specified data source does not contain items.
* You use the [DataAsync](https://docs.devexpress.com/Blazor/DevExpress.Blazor.Base.DxListEditorBase-2.DataAsync) property or the [CustomData](https://docs.devexpress.com/Blazor/DevExpress.Blazor.Base.DxListEditorBase-2.CustomData) property to bind the List Box to a data source. The component sends the first request to a remote data source and waits for a response.
