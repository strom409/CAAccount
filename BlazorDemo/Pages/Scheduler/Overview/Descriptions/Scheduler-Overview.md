...
**Keyboard Support**  
The Scheduler supports [keyboard shortcuts](https://docs.devexpress.com/Blazor/405191/components/scheduler/keyboard-support) that allow users to navigate through toolbar items and appointments, and execute built-in commands.
