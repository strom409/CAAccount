The DevExpress [TreeView](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxTreeView) component for Blazor allows you to define custom templates for its nodes.
