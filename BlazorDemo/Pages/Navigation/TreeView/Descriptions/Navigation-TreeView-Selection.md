...
The TreeView component also supports [keyboard navigation](https://docs.devexpress.com/Blazor/DevExpress.Blazor.DxTreeView#keyboard-navigation). Press the Tab key or Shift+Tab to focus the TreeView and use Arrow keys to navigate through nodes.
